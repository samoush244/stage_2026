...
router.post("/", protect, requireRole(["admin"]), uploadPlayerImage.single("photo"), createPlayer);
router.put("/:id", protect, requireRole(["admin"]),uploadPlayerImage.single("photo"), updatePlayer);
