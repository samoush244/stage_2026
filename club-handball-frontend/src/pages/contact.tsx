...
export default function Contact() {
  ...
  const handleSubmit = async (e:React.FormEvent) => {
    ...
    setSuccessMessage("Votre message a bien été envoyé. Nous vous répondrons rapidement.");
setErrorMessage("");
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 pt-20 pb-10">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-300">
          Une question sur le club, les équipes, les horaires, les bénévoles, la Red Army
          ou une demande particulière ? Envoyez-nous un message.
        </p>
      </section>
         {successMessage && (
